...
Cypress.Commands.add('cleanOpenAnswerQuestionsByName', (questionName) => {
  dbCommand(`DELETE FROM discussions`);
  dbCommand(`DELETE FROM item_combination_answer_combination`);
  dbCommand(`DELETE FROM answer_details`);
  dbCommand(`DELETE FROM question_answers`);
  dbCommand(`DELETE FROM quiz_answers`);
  dbCommand(`DELETE FROM quiz_questions`);
  dbCommand(`DELETE FROM quizzes`);
  dbCommand(`DELETE FROM combinations`);
  dbCommand(`DELETE FROM combination_options`);
  dbCommand(`DELETE FROM options`);
  dbCommand(`DELETE FROM question_details`);
  dbCommand(`DELETE FROM questions`);
