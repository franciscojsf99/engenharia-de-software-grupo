...
@DataJpaTest
class TeacherExportsQuizToXMLTest extends SpockTest {
    ...
    def 'export quiz to xml with 2 students answers'() {
        ...
        statementAnswerDtoStudent2.setAnswerDetails(openAnswerAnswerDtoStudent1)
