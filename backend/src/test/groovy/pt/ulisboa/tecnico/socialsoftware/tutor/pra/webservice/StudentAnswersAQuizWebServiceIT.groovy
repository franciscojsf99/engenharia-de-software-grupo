...
class StudentAnswersAQuizWebServiceIT extends SpockTest {
    @LocalServerPort
    private int port
    ...
    def "Start a quiz and submit an answer"() {
        ...
        openAnswerStatementAnswerDetailsDto.setAnswer(QUESTION_1_ANSWER)
        ...
        and:
        def data = response.data.get(0)
        data.correctAnswerDetails.correctAnswer == QUESTION_1_ANSWER
        data.correctAnswerDetails.type == "open_answer"
    }
