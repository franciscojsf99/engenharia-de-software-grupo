...
class SpockTest extends Specification {
    ...
    public static final String QUESTION_1_ANSWER = "Open Answer Question 1"

    public static final String QUESTION_2_ANSWER = "Open Answer Question 2"

    public static final String LEFT_COMBINATION_OPTION_1_CONTENT = "Left Combination Option 1 Content"
    public static final String LEFT_COMBINATION_OPTION_2_CONTENT = "Left Combination Option 2 Content"
    public static final String LEFT_COMBINATION_OPTION_3_CONTENT = "Left Combination Option 3 Content"
    public static final String RIGHT_COMBINATION_OPTION_1_CONTENT = "Right Combination Option 1 Content"
    public static final String RIGHT_COMBINATION_OPTION_2_CONTENT = "Right Combination Option 2 Content"
    public static final String RIGHT_COMBINATION_OPTION_3_CONTENT = "Right Combination Option 3 Content"
