...
@DataJpaTest
class ImportMultipleChoiceQuestionFromXMLTest extends SpockTest{
    ...
    def "export and import a multiple choice question with xml"(){
        ...
        optionOneResult.getImportance() == 1
