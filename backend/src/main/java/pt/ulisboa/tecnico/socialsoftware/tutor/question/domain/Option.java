...
import static pt.ulisboa.tecnico.socialsoftware.tutor.exceptions.ErrorMessage.INVALID_IMPORTANCE_FOR_OPTION;
...
public class Option implements DomainEntity {
    ...
    public Option(OptionDto option) {
        ...
        if (option.isCorrect())setImportance(option.getImportance());
    ...
    public void setImportance(Integer importance) {
        if (importance == null || importance < 0)
            throw new TutorException(INVALID_IMPORTANCE_FOR_OPTION);
