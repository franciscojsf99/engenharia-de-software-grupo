...
public abstract class LatexVisitor implements Visitor {
    ...
    public void visitQuestionDetails(OpenAnswerQuestion question) {
        this.result = this.result + "\\putAnswer\n";
    ...
    @Override
    public void visitCombinationOption(CombinationOption combinationOption) {
        this.result = this.result + "\t\\combinationOption " + String.valueOf(combinationOption.getType()).toLowerCase() + " {" + combinationOption.getContent() + "}\n";
    }

    @Override
    public void visitCombination(Combination combination) {
        this.result = this.result + "\t\\combination {\"" + combination.getLeftOption().getContent() + "\" -> \"" + combination.getRightOption().getContent() + "\"}\n";
    }
