...
public class QuestionsXmlImport {
    ...
    private QuestionDetailsDto importItemCombinationQuestion(Element questionElement) {
        List<CombinationOptionDto> combinationOptionDtos = new ArrayList<>();
        for (Element optionElement : questionElement.getChild("combinationOptions").getChildren("combination_option")) {
            String content = optionElement.getAttributeValue("content");
            CombinationOption.Type column = CombinationOption.Type.valueOf(optionElement.getAttributeValue("column"));

            CombinationOptionDto combinationOptionDto = new CombinationOptionDto();
            combinationOptionDto.setContent(content);
            combinationOptionDto.setType(column);

            combinationOptionDtos.add(combinationOptionDto);
        }

        List<CombinationDto> combinationDtos = new ArrayList<>();
        for (Element optionElement : questionElement.getChild("combinations").getChildren("combination")) {

            List<Element> combinationElements = optionElement.getChildren();
            Element leftCombinationOptionElement = combinationElements.get(0);
            Element rightCombinationOptionElement = combinationElements.get(1);

            CombinationOptionDto leftCombinationOptionDto = new CombinationOptionDto();
            String content = leftCombinationOptionElement.getAttributeValue("content");
            CombinationOption.Type column = CombinationOption.Type.valueOf(
                    leftCombinationOptionElement.getAttributeValue("column"));
            leftCombinationOptionDto.setContent(content);
            leftCombinationOptionDto.setType(column);

            CombinationOptionDto rightCombinationOptionDto = new CombinationOptionDto();
            content = rightCombinationOptionElement.getAttributeValue("content");
            column = CombinationOption.Type.valueOf(
                    rightCombinationOptionElement.getAttributeValue("column"));
            rightCombinationOptionDto.setContent(content);
            rightCombinationOptionDto.setType(column);

            CombinationDto combinationDto = new CombinationDto();
            combinationDto.setLeftOption(leftCombinationOptionDto);
            combinationDto.setRightOption(rightCombinationOptionDto);

            combinationDtos.add(combinationDto);
        }

        ItemCombinationQuestionDto itemCombinationQuestionDto = new ItemCombinationQuestionDto();
        itemCombinationQuestionDto.setOptions(combinationOptionDtos);
        itemCombinationQuestionDto.setCombinations(combinationDtos);
    ...
    private QuestionDetailsDto importMultipleChoiceQuestion(Element questionElement) {
        ...
        for (Element optionElement : questionElement.getChild("options").getChildren("option")) {
            Integer optionImportance = Integer.valueOf(optionElement.getAttributeValue("importance"));
            ...
            optionDto.setImportance(optionImportance);
