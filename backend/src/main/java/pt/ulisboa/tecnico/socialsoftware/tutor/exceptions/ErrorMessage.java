...
public enum ErrorMessage {
    CANNOT_CREATE_ITEM_COMBINATION_QUESTION_WITH_EMPTY_COLUMN("Cannot have empty column"),
    COMBINATION_OPTION_NOT_FOUND("Combination option not found with id %d"),
    COMBINATION_NOT_FOUND("Combination not found with id %d"),
    INVALID_CONTENT_FOR_COMBINATION_OPTION("Invalid content for combination option"),
    INVALID_NULL_COMBINATION("Invalid combination, one type is null"),
    INVALID_NULL_COMBINATION_OPTION("Invalid combination option, is null"),
    INVALID_COMBINATION("Invalid combination"),
    DUPLICATE_ITEM_COMBINATION_OPTION("Item combination option already exists in this column"),
    DUPLICATE_COMBINATION("Combination already exists"),
    ZERO_COMBINATIONS("There must be at least one combination"),
    ...
    INVALID_IMPORTANCE_FOR_OPTION("Invalid importance for option"),
    ...
    INVALID_CONTENT_FOR_ANSWER( "Invalid content for answer"),
    ...
    QUESTION_COMBINATION_OPTION_MISMATCH("Question %d does not have combination option %d"),
